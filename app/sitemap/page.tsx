...
export default function SitemapPage() {
  ...
  // Auto-generated page data - Updated: 2026-03-08T17:21:21.443Z
  const pageData = {
    "services": [
      {
    ...
    "main": [
      {
        "path": "/blogs",
        "name": "Blogs",
        "description": "Blog posts and articles - Frameleads digital marketing"
      },
      {
        "path": "/blogs/categories",
        "name": "Blogs - Categories",
        "description": "Browse all blog categories - Frameleads digital marketing"
      },
      {
        "path": "/contact",
        "name": "Contact",
