      ...
      <div className="min-h-screen bg-[#FDFDFD] text-slate-900 font-sans selection:bg-[#FF6B35] selection:text-white pb-20 overflow-x-hidden">
            ...
            <div className="grid lg:grid-cols-2 gap-20 items-center">
              <div className="order-2 lg:order-1">
                <div className="grid grid-cols-2 gap-8">
                  {[
                    { label: 'LTV Discovery', val: '4:1 Ratio', color: 'text-emerald-400' },
                    { label: 'CAC Efficiency', val: '-18% MoM', color: 'text-[#FF6B35]' },
                    { label: 'Data Sync', val: 'Real-time', color: 'text-blue-400' },
                    { label: 'Expansion', val: 'High-Velocity', color: 'text-purple-400' }
                  ].map((stat, i) => (
        ...
        <section className="py-32 px-6 relative bg-white">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-20">
              <h2 className="text-5xl md:text-7xl font-black text-slate-900 mb-8 tracking-tighter">SaaS Growth Deep-Dive</h2>
              <p className="text-xl text-slate-500 font-medium italic">Technical answers for technical founders.</p>
            </div>

            <div className="space-y-6">
              {faqs.map((faq, i) => (
                <div key={i} className="border-b-4 border-slate-900">
                  <button
