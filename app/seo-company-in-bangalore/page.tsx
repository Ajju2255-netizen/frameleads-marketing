...
export default function SEOCompanyBangalorePage() {
  ...
  const testimonials = [
    {
      name: "Rajesh Kumar",
      business: "Tech Startup, Koramangala",
      rating: 5,
      text: "Frameleads helped us become the go-to tech solution in Koramangala. Our local visibility increased dramatically!",
    },
    {
      name: "Priya Sharma",
      business: "Boutique Store, Indiranagar",
      rating: 5,
      text: "Thanks to their local SEO expertise, we're now the top-ranked boutique in Indiranagar. Sales have doubled!",
    },
    {
      name: "Amit Patel",
      business: "Dental Clinic, Whitefield",
      rating: 5,
      text: "Our clinic is now #1 for dental services in Whitefield. The team understands Bangalore market perfectly.",
    },
  ]
  ...
  return (
    <div className="min-h-screen bg-gray-900">
      ...
      <section className="bg-gray-800 py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-white mb-6">What Bangalore Businesses Say</h2>
            <p className="text-xl text-gray-400">Hear from local business owners who've grown with our SEO services.</p>
          </div>
            ...
            {testimonials.map((testimonial, index) => (
              <Card key={index} className="bg-gray-700 border-gray-600">
                <CardContent className="p-6">
                  ...
                  <blockquote className="text-gray-300 mb-4 leading-relaxed">"{testimonial.text}"</blockquote>
                  <div>
      ...
      <section className="bg-black py-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-400 mb-10 leading-relaxed">
            Join 500+ successful Bangalore businesses that trust Frameleads for their SEO needs. Get your free audit and
            discover how we can help you outrank your competitors.
          </p>
