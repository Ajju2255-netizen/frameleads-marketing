                  ...
                  <div className="bg-white rounded-3xl p-6 shadow-2xl border border-slate-100 relative z-10">
                    ...
                    <div className="space-y-4">
                      <div className="flex justify-between items-center text-sm font-bold">
                        ...
                        <span className="text-green-500 flex items-center gap-1"><CheckCircle2 className="w-4 h-4" /> PROTECTED</span>
                      </div>
                      ...
                      <div className="flex justify-between items-center text-sm font-bold pt-4">
                        ...
                        <span className="text-blue-500 flex items-center gap-1"><ShieldCheck className="w-4 h-4" /> ACTIVE</span>
                      </div>
                      <div className="w-full bg-slate-100 h-2 rounded-full">
                        <div className="w-11/12 h-full bg-blue-500 rounded-full" />
                      </div>
                    </div>
                  </div>
